...
export default function PeakScoreTracker({
  ...
  return (
    <div className="flex items-center justify-center relative w-full">
      ...
      <div className="absolute top-9 left-56 bg-gradient-to-r from-amber-500 to-yellow-500 text-white text-sm font-bold px-3 py-2 rounded-full shadow-xl border-2 border-amber-300 z-50">
